    ...
    const signUp = async (e) => {
        ...
        if (handle == "bank") {
            formData = {
                ...
                email: bankmail,
                password: password,
                Province: data.Provinces[Province].Province,
                district: data.Provinces[Province].districts[district],
                address: address,
                latitude: latitude,
                longitude: longitude,
                    ...
                    >
                        <fieldset className="border border-solid border-gray-300 px-12 py-5">
                            <legend className={`text-2xl font-bold mb-1 ${auth === 1 && "text-center"}`}>
                                &nbsp;{handle === "bank" ? (auth === 1 ? "Blood Bank Log In" : "Add Your Bloodlink") : (handle === "donor" ? "Donor" : "Patient")} {handle !== "bank" && (auth === 0 ? "Sign Up" : "Log In")}&nbsp;
                            </legend>
                            <legend align="right">
                                    ...
                                    }
                                    {
                                        handle !== "bank" && <><div><label className="font-semibold  leading-8">Age:<font color="red">*</font></label>
                                            ...
                                            <div>
                                                ...
                                                <select name="blood" id="Province" onChange={(e) => setBlood(e.target.value)} className="w-full p-3 text-md border border-silver rounded">
                                                    {
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select name="Province" id="Province" onChange={(e) => { setProvince(e.target.value); setDistrict(0); }} className="w-full p-3 text-md border border-silver rounded">
                                                {
                                                    data.Provinces.map((e, i) => <option value={i}>{e.Province}</option>)
                                                }
                                            </select>
                                        </div>
                                        ...
                                        <div><label for="district" className="font-semibold  leading-8">District:<font color="red">*</font></label>
                                            <select name="district" id="district" onChange={(e) => setDistrict(e.target.value)} className="w-full p-3 text-md border border-silver rounded">
                                                {
                                                    data.Provinces[Province].districts.map((e, i) => <option value={i}>{e}</option>)
                                                }
                                            </select></div>
