...
const EditProfile = () => {
    ...
    useEffect(() => {
        ...
        setMail(user.email);
        setPhone(user.phone);
        data.Provinces.map((e, i) => {
            if (e.Province === user.Province) {
                setProvince(i);
                    ...
                    <table className="w-full" cellPadding={15}>
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="blood" id="Province" disabled={edit} onChange={(e) => setBlood(e.target.value)} className="w-full p-3 text-md border border-silver rounded">
                                    {
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="Province" id="Province" disabled={edit} onChange={(e) => { setProvince(e.target.value); setDistrict(0); }} className="w-full p-3 text-md border border-silver rounded">
                                    {
